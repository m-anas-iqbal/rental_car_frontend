            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h5 style="display: inline">Car Brands Details </h5>
                        <a href="{{url('admin/car_brands/add')}}"
                                    ...
                                    <thead>
                                        ...
                                        <tr role="row">
                                            ...
                                            <th class="sorting" tabindex="0" aria-controls="example-style-4"
                                                ...
                                                rowspan="1" colspan="1" aria-sort="ascending"
                                                aria-label="Name: activate to sort column descending"
                                                style="width: 100.925px;">Status</th>
                                    ...
                                    <tbody>
                                        @foreach ($car_brand as $item)
                                            <tr role="row" class="odd">
                                                ...
                                                <td>
                                                    @if ($item->status == 1)
                                                        <a href="{{ url('admin/car_brands/' . \Crypt::encrypt($item->id) . '/0') }}"
                                                            class="btn btn-success" type="button">Active</a>
                                                    @else
                                                        <a href="{{ url('admin/car_brands/' . \Crypt::encrypt($item->id) . '/1') }}"
                                                            class="btn btn-danger">Deactive</a>
                                                    @endif
                                                </td>
                                                <td><a class="btn btn-success theme"
                                                        href="{{ url('admin/car_brands/edit/' . \Crypt::encrypt($item->id)) }}"
