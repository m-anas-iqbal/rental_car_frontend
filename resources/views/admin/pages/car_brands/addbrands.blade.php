...
@section('breadcrumb-items')
    ...
    <li class="breadcrumb-item active"> Add Car Brand</li>
@endsection
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="{{url('admin/car_brands/add')}}" class="theme-form mega-form" method="POST" enctype="multipart/form-data">
                                    @csrf
