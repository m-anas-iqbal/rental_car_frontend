            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h5 style="display: inline">Car Addons Details </h5>
                        <a href="{{url('admin/car_addons/add')}}"
                        ...
                        <div class="table-responsive">
                            <div id="example-style-4_wrapper" class="dataTables_wrapper">
                                ...
                                <table class="hover dataTable" id="example-style-4" role="grid"
                                    ...
                                    <thead>
                                        ...
                                        <tr role="row">
                                            <th class="sorting_asc" tabindex="0" aria-controls="example-style-4"
                                                ...
                                                style="width: 170.925px;">Name</th>

                                            <th class="sorting_asc" tabindex="0" aria-controls="example-style-4"
                                                rowspan="1" colspan="1" aria-sort="ascending"
                                                aria-label="Name: activate to sort column descending"
                                                style="width: 170.925px;">Buying Price</th>

                                            <th class="sorting" tabindex="0" aria-controls="example-style-4"
                                                rowspan="1" colspan="1"
                                                aria-label="Salary: activate to sort column ascending"
                                                style="width: 99px;">Rent Price</th>
                                                <th class="sorting_asc" tabindex="0" aria-controls="example-style-4"
                                                rowspan="1" colspan="1" aria-sort="ascending"
                                                aria-label="Name: activate to sort column descending"
                                                style="width: 170.925px;">Stock</th>
                                            <th class="sorting" tabindex="0" aria-controls="example-style-4"
                                                rowspan="1" colspan="1"
                                                aria-label="Salary: activate to sort column ascending"
                                    ...
                                    <tbody>
                                        @foreach ($car_addon as $item)
                                            <tr role="row" class="odd">
                                                <td class="sorting_1">{{ $item->addon_name }}</td>
                                                <td class="sorting_1">{{ $item->buying_price }}</td>
                                                <td class="sorting_1">{{ $item->rent_price }}</td>
                                                ...
                                                <td>
                                                    @if ($item->status == 1)
                                                        <a href="{{ url('admin/car_addons/' . \Crypt::encrypt($item->id) . '/0') }}"
                                                            class="btn btn-success" type="button">Active</a>
                                                    @else
                                                        <a href="{{ url('admin/car_addons/' . \Crypt::encrypt($item->id) . '/1') }}"
                                                            class="btn btn-danger">Deactive</a>
                                                    @endif
                                                </td>
                                                <td><a class="btn btn-success mb-3 theme"
                                                        href="{{ url('admin/car_addons/edit/' . \Crypt::encrypt($item->id)) }}"
                                                        ...
                                                        href="{{ url('admin/car_addons/view/' . \Crypt::encrypt($item->id)) }}"
                                                        type="button" data-original-title="btn btn-danger btn-xs"
