                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="{{url('admin/car_addons/add')}}" class="theme-form mega-form" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" name="addon_name" value="" type="numberyy"
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" name="stock" value="" type="number"
                                                    placeholder="Enter Stock" data-bs-original-title="" title="">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" name="buying_price" value="" type="number"
                                ...
                                @endif --}}
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" name="rent_price" value="" type="number"
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                ...
                                                <textarea rows="10" id="editor" class="form-control" name="description"
                                    ...
                                    <a href="{{url('admin/car_addons')}}" type="submit" class="btn btn-primary text-end mt-2" style=""
