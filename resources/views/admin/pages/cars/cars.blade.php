            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h5 style="display: inline">Cars Details </h5>
                        <a href="{{url('admin/cars/add')}}"
                        ...
                        <div class="table-responsive">
                            <div id="example-style-4_wrapper" class="dataTables_wrapper">
                                ...
                                <table class="hover dataTable" id="example-style-4" role="grid"
                                    ...
                                    <thead>
                                        ...
                                        <tr role="row">
                                            <th class="sorting_asc" tabindex="0" aria-controls="example-style-4"
                                                ...
                                                style="width: 170.925px;"> Car Name</th>

                                            <th class="sorting_asc" tabindex="0" aria-controls="example-style-4"
                                                rowspan="1" colspan="1" aria-sort="ascending"
                                                aria-label="Name: activate to sort column descending"
                                                style="width: 170.925px;">Rent Price</th>

                                            <th class="sorting" tabindex="0" aria-controls="example-style-4"
                                                rowspan="1" colspan="1"
                                                aria-label="Salary: activate to sort column ascending"
                                                style="width: 99px;">Reg # No</th>
                                                <th class="sorting" tabindex="0" aria-controls="example-style-4"
                                                rowspan="1" colspan="1"
                                                aria-label="Salary: activate to sort column ascending"
                                                style="width: 99px;">Car Brand</th>
                                                <th class="sorting_asc" tabindex="0" aria-controls="example-style-4"
                                                rowspan="1" colspan="1" aria-sort="ascending"
                                                aria-label="Name: activate to sort column descending"
                                                style="width: 170.925px;">Car Model</th>
                                                <th class="sorting" tabindex="0" aria-controls="example-style-4"
                                                rowspan="1" colspan="1"
                                                aria-label="Salary: activate to sort column ascending"
                                                style="width: 99px;"> Model Year</th>
                                            <th class="sorting" tabindex="0" aria-controls="example-style-4"
                                                rowspan="1" colspan="1"
                                                aria-label="Salary: activate to sort column ascending"
                                    ...
                                    <tbody>
                                        @foreach ($get_cars as $item)
                                            <tr role="row" class="odd">
                                                <td class="sorting_1">{{ $item->car_name }}</td>
                                                <td class="sorting_1">{{ $item->car_rent_price }}</td>
                                                <td class="sorting_1">{{ $item->car_registration_no }}</td>
                                                <td class="sorting_1">{{ $item->car_brand }}</td>
                                                <td class="sorting_1">{{ $item->car_model }}</td>
                                                <td class="sorting_1">{{ $item->model_year }}</td>
                                    ...
                                    <tfoot>
                                        <tr>
                                            <th rowspan="1" colspan="1"> Car Name</th>
                                            <th rowspan="1" colspan="1">Rent Price</th>
                                            <th rowspan="1" colspan="1">Reg # No</th>
                                            <th rowspan="1" colspan="1">Car Brand</th>
                                            <th rowspan="1" colspan="1">Car Model</th>
                                            <th rowspan="1" colspan="1">Model Year</th>
