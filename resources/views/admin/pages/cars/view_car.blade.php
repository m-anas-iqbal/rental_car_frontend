                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="number" value="{{ $get_car->discount }}" readonly
                                                    name="discount" min="0" max="100" class="form-control">
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" value="{{ $get_car->after_discount }}" readonly
                                                    name=" rent_price" value="" type="number"
                                                    placeholder="Enter Rent Price" data-bs-original-title="" title="">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="number"
                                                    @if ($get_car->after_discount > 0) value="{{ $get_car->car_rent_price-$get_car->after_discount }}" @else value="{{ $get_car->car_rent_price }}" @endif"
                                                    readonly name="discount" min="0" max="100"
                                                    class="form-control">
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" name="car_make"
                                                    value="{{ $get_car->car_make }}" type="text"
                                                    placeholder="Enter Car Make" data-bs-original-title=""
                                                    title="">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" name="car_model"
                                                    value="{{ $get_car->car_model }}" type="text"
                                                    placeholder="Enter Car Model" data-bs-original-title=""
                                                    title="">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" name="model_year"
                                                    value="{{ $get_car->model_year }}" type="text"
                                                    placeholder="Enter Model Year" data-bs-original-title=""
                                                    title="">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" name="product_type"
                                                    value="{{ $get_car->product_type }}" type="text"
                                                    placeholder="Enter Product Type" data-bs-original-title=""
                                                    title="">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" name="car_series"
                                                    value="{{ $get_car->series }}" type="text"
                                                    placeholder="Enter Car Series" data-bs-original-title=""
                                                    title="">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" name="car_drive"
                                                    value="{{ $get_car->drive }}" type="text"
                                                    placeholder="Enter Car Drive" data-bs-original-title=""
                                                    title="">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" name="fuel_type_primary"
                                                    value="{{ $get_car->fuel_type_primary }}" type="text"
                                                    placeholder="Enter Fuel Type Primary" data-bs-original-title=""
                                                    title="">
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" name="manufacturer"
                                                    value="{{ $get_car->manufacturer }}" type="text"
                                                    placeholder="Enter Manufacturer" data-bs-original-title=""
                                                    title="">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" name="no_of_doors"
                                                    value="{{ $get_car->no_of_doors }}" type="text"
                                                    placeholder="Enter Number Of Doors" data-bs-original-title=""
                                                    title="">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" name="no_of_seats"
                                                    value="{{ $get_car->no_of_seats }}" type="text"
                                                    placeholder="Enter Number Of Seats" data-bs-original-title=""
                                                    title="">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" name="max_trunk_capacity"
                                                    value="{{ $get_car->max_trunk_capacity }}" type="text"
                                                    placeholder="Enter Max Trunk Capacity" data-bs-original-title=""
                                                    title="">
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <select name="is_borrowed" class="form-control" id="">
                                                    <option @if ($get_car->is_borrowed == '1') selected @endif 
                                                        value="1">Yes</option>
                                                    <option @if ($get_car->is_borrowed == '0') selected @endif 
                                                        value="0">No</option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <select name="vehicle_type" aria-label="Default select example"
                                                    ...
                                                    <option @if ($get_car->vehicle_type == 'Luxury') selected @endif
                                                        value="Luxury">Luxury</option>
                                                    <option @if ($get_car->vehicle_type == 'SUV') selected @endif
                                                        value="SUV">SUV</option>
                                                    <option @if ($get_car->vehicle_type == 'Sedan') selected @endif
                                                        value="Sedan">Sedan</option>
                                                    <option @if ($get_car->vehicle_type == 'Economy') selected @endif
                                                        value="Economy">Economy</option>
                                                    <option @if ($get_car->vehicle_type == 'Sports') selected @endif
                                                        value="Sports">Sports</option>
                                                    <option @if ($get_car->vehicle_type == 'Convertible') selected @endif
                                                        value="Convertible">Convertible</option>
                                                    <option @if ($get_car->vehicle_type == 'CrossOver') selected @endif
                                                        value="CrossOver">CrossOver</option>
                                                    <option @if ($get_car->vehicle_type == 'SuperCar') selected @endif
                                                        value="SuperCar">SuperCar</option>
                                                    <option @if ($get_car->vehicle_type == 'Musle') selected @endif
                                                        value="Muscle">Muscle</option>
                                                    <option @if ($get_car->vehicle_type == 'Special Edition') selected @endif
                                                        value="Special Edition">Special Edition</option>
                                                    <option @if ($get_car->vehicle_type == 'Coupe') selected @endif
                                                        value="Coupe">Coupe</option>
                                                    <option @if ($get_car->vehicle_type == 'Compact') selected @endif
                                                        value="Compact">Compact</option>
                                                    <option @if ($get_car->vehicle_type == 'Electric') selected @endif
