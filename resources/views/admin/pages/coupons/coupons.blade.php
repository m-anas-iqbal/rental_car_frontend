                                    ...
                                    <thead>
                                        ...
                                        <tr role="row">
                                            ...
                                            <th class="sorting_asc" tabindex="0" aria-controls="example-style-4"
                                                rowspan="1" colspan="1" aria-sort="ascending"
                                                aria-label="Name: activate to sort column descending"
                                                style="width: 170.925px;">Coupon Type</th>
                                    ...
                                    <tbody>
                                        @foreach ($coupons as $item)
                                            <tr role="row" class="odd">
                                                ...
                                                <td class="sorting_1">{{ $item->coupon_type }}</td>
                                                <td class="sorting_1">{{ $item->coupon_amt }}</td>
                                                ...
                                                <td>
                                                    {{-- <a class="btn btn-success mb-3 theme"
                                                        href="{{ url('admin/coupons/edit/' . \Crypt::encrypt($item->id)) }}"
                                                        ...
                                                        href="{{ url('admin/coupons/delete/' . \Crypt::encrypt($item->id)) }}"
                                                        type="button" data-original-title="btn btn-danger btn-xs"
