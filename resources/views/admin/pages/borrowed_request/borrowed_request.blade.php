...
@section('breadcrumb-title')
    <h3>Borrowed Request</h3>
@endsection

@section('breadcrumb-items')
    <li class="breadcrumb-item">Borrowed Request</li>
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h5 style="display: inline">Borrowed Request Details </h5>
                    </div>
                    <div class="card-body">
                                    ...
                                    <thead>
                                        ...
                                        <tr role="row">
                                            ...
                                            <th class="sorting_asc" tabindex="0" aria-controls="example-style-4"
                                                rowspan="1" colspan="1" aria-sort="ascending"
                                                aria-label="Name: activate to sort column descending"
                                                style="width: 170.925px;">Car Detail</th>
                                            ...
                                            <th class="sorting_asc" tabindex="0" aria-controls="example-style-4"
                                                rowspan="1" colspan="1" aria-sort="ascending"
                                                aria-label="Name: activate to sort column descending"
                                                style="width: 170.925px;">Drop Off Location</th>
                                            <th class="sorting_asc" tabindex="0" aria-controls="example-style-4"
                                                rowspan="1" colspan="1" aria-sort="ascending"
                                                aria-label="Name: activate to sort column descending"
                                                style="width: 170.925px;">Pick Up Date</th>
                                            <th class="sorting_asc" tabindex="0" aria-controls="example-style-4"
                                                rowspan="1" colspan="1" aria-sort="ascending"
                                                aria-label="Name: activate to sort column descending"
                                                style="width: 170.925px;">Drop Off Date</th>
                                            <th class="sorting" tabindex="0" aria-controls="example-style-4"
                                                rowspan="1" colspan="1"
                                        ...
                                        @foreach ($bo_request as $item)
                                            <tr role="row" class="odd">
                                                ...
                                                <td class="sorting_1"><a class="btn btn-primary"
                                                        ...
                                                        Detail</a></td>
                                                <td class="sorting_1">{{ $item->pick_up_location }}</td>
                                                <td class="sorting_1">{{ $item->drop_off_location }}</td>
                                                ...
                                                <td>
                                                    <a class="btn btn-success  theme"
                                                        href="{{ url('admin/borrowed_request/send_request/' . \Crypt::encrypt($item->id)) }}"
