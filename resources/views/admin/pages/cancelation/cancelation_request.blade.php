...
@section('breadcrumb-title')
    <h3>Cancelation Request</h3>
@endsection

@section('breadcrumb-items')
    <li class="breadcrumb-item">Cancelation Request</li>
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h5 style="display: inline">Cancelation Request Details </h5>
                    </div>
                    <div class="card-body">
                                    ...
                                    <thead>
                                        ...
                                        <tr role="row">
                                            ...
                                            <th class="sorting_asc" tabindex="0" aria-controls="example-style-4"
                                                rowspan="1" colspan="1" aria-sort="ascending"
                                                aria-label="Name: activate to sort column descending"
                                                style="width: 170.925px;">Contact No</th>

                                            <th class="sorting_asc" tabindex="0" aria-controls="example-style-4"
                                                rowspan="1" colspan="1" aria-sort="ascending"
                                                aria-label="Name: activate to sort column descending"
                                                style="width: 170.925px;">Order No</th>
                                            ...
                                            <th class="sorting_asc" tabindex="0" aria-controls="example-style-4"
                                                rowspan="1" colspan="1" aria-sort="ascending"
                                                aria-label="Name: activate to sort column descending"
                                                style="width: 170.925px;">Aprroved</th>
                                    ...
                                    <tbody>
                                        @foreach ($cancelation_request as $item)
                                            <tr role="row" class="odd">
                                                ...
                                                <td>{{ $item->created_at?->isoFormat('D-M-Y h:s') }}</td>
                                                <td>
                                                    <a class="btn btn-success  theme"
                                                        href="{{ url('admin/cancelation_request/' . \Crypt::encrypt($item->order_id)) }}"
